	...
	return (
		<section className="categories">
			<div className="container">
				<h2 className="text-[32px] leading-[48px] mb-3 text-center">{t("categories.title")}</h2>
				...
				{!isBooks ? (
					<ul className="grid grid-cols-4 gap-x-5 gap-y-6">
						{array &&
							array.map((item) => (
								<li className="rounded-[22px] bg-[#F5F5F5] dark:bg-[#1E1E1E]">
									<img
										className="rounded-t-[22px] mb-3"
										src="https://placehold.co/295x244"
										alt=""
										width={295}
										height={244}
									/>
									<div className="min-h-[129px] p-4 pt-3 dark:text-[#C9AC8C] text-black">
							...
							array.map((item) => (
								<li>
									<img
										...
										alt=""
									/>
									<h3 className="text-lg font-bold leading-9 mb-1.5">Dunyoning ishlari</h3>
									<span className="text-justify text-[#00000099] leading-6 dark:text-[#FFFFFF99]">
										1878-1934
									</span>
								</li>
